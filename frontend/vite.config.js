...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'EduBridge — Free AI Tutor',
        short_name: 'EduBridge',
        description: 'Free AI tutor for every Indian child, in 7 Indian languages. Works on any phone.',
        theme_color: '#02D8E9',
      ...
      workbox: {
        ...
        // Cache Google Fonts and serve them offline after first visit
        runtimeCaching: [
          {
